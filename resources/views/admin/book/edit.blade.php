        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                ...
                <div class="box-body border border-primary">
                    <form role="form" name="category_form" id="category_form" action="{{ url('admin/books/update') }}" method="post" enctype="multipart/form-data">
                    {!!Form::hidden('id',$info->id, ['class' => 'form-control'])!!}
                        {{ csrf_field() }}
                        ...
                        <div class="box-body col-md-12">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 ">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title" placeholder="Enter title" value="{{ old('title', $info->title) }}">
                                    @if ($errors->has('title'))
                                ...
                                <div class="form-group col-md-2">
                                    <img src="{{ $info->preview }}" class="rounded" height="100px" width="150px;">
                                </div>
                                ...
                                <div class="form-group col-md-6 ">
                                    ...
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                       ...
                                       <input type="radio" name="status" id="active" autocomplete="off" value="1" {{ ($info->status == 1) ? ('checked') : ('') }}> Active
                                       </label>
                                       <label class="btn btn-secondary">
                                       <input type="radio" name="status" id="inactive" autocomplete="off" value="0" {{ ($info->status == 0) ? ('checked') : ('') }}> Inactive
                                       </label>
                                    </div>
                                 </div>
