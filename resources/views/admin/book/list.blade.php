          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="box-tools float-right">
                <a href="{{ url('admin/courses/'.$course_id.'/books/create') }}" class="btn btn-success"
                  style="padding-bottom: 3px;">
                  <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp; Add Ebook</a>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
  ...
  $(document).ready(function () {
    if ($('#ebooks-list').length > 0) {
      var tableData = $('#ebooks-list').DataTable({
        ...
        ajax: {
          url: "{{ url('admin/courses/'.$course_id.'/books') }}",
          //url: "http://chatsupport.co.in/admin/courses/'.$course_id.'/books",
          type: 'GET',
        },
