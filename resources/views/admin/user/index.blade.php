            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="box-tools float-right">
                  <a href="{{url('admin/users/create')}}" class="btn btn-success" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp; Add</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
$(document).ready(function () {
    ...
    var tableData = $('#users-list').DataTable({
            ...
            columns: [
              ...
              {data: 'email', name: 'email', 'visible': true,searchable: true},
              {data: 'mobile_number', name: 'mobile_number', 'visible': true,searchable: true},
