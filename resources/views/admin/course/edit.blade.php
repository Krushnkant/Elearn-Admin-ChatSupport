        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                ...
                <div class="box-body border border-primary">
                    <form role="form" name="add_course_form" id="add_course_form" action="{{ url('admin/courses/update') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" id="id" value="{{ (!empty($course_info->id) ? ($course_info->id) : ('')) }}">
                        <div class="box-body col-md-12">
                            
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="name">Name<span class="text-danger">*</span></label>
                                    <input type="text" name="name" class="form-control" id="name" value="{{ old('name', !empty($course_info->name) ? $course_info->name : '') }}" placeholder="Enter name">
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="mock_exam_count" class="form-control" id="mock_exam_count" value="{{ old('mock_exam_count', !empty($course_info->mock_exam_count) ? $course_info->mock_exam_count : '') }}" placeholder="Enter mock_exam_count" min="1">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="skill_id">Skill<span class="text-danger">*</span></label>
                                    <select class="form-control" name="skill_id" id="skill_id">
                                        <option value="">Select skill</option>
                                        @if(!empty($skill_info))
                                            @foreach($skill_info as $skill)
                                                <option value="{{ $skill->id }}" {{ $skill->id == $course_info->skill_id ? 'selected' : '' }}>{{ $skill->name }}</option>
                                            @endforeach
                                       @endif
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="duration" class="form-control" id="duration" value="{{ old('duration', !empty($course_info->duration) ? $course_info->duration : '') }}" placeholder="Enter duration">
                                ...
                                <div class="form-group col-md-6" style="margin-top:20px";>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="trainnig_mode" id="flexible" value="1" {{ $course_info->originalTrainnigMode == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group col-md-2">
                                    <img src="{{ $course_info->image }}" class="rounded" height="100px" width="150px;">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="overview">Course Overivew<span class="text-danger">*</span></label>
                                    <textarea class="form-control" name="overview" id="overview">{{ old('overview', !empty($course_info->overview) ? $course_info->overview : '') }}</textarea>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" name="mock_test" id="mock_test">{{ old('mock_test', !empty($course_info->mock_test) ? $course_info->mock_test : '') }}</textarea>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" name="course_outline" id="course_outline">{{ old('course_outline', !empty($course_info->course_outline) ? $course_info->course_outline : '') }}</textarea>
