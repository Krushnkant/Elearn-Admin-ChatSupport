            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="box-tools float-right">
                  <a href="{{url('admin/courses/create')}}" class="btn btn-success" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp; Add</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
$(document).ready(function () {
    ...
    var tableData = $('#courser-list').DataTable({
            ...
            ajax: {
               ...
               // url: "https://chatsupport.co.in/admin/courses",
                type: 'GET',
            },
