        ...
        @endif
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <a href="{{url('admin/courses/'.$course_id.'/assessments/create')}}" class="btn btn-success" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp; Add Assessment</a>
            </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="assessment-list" class="table table-bordered table-striped">
                <input type="hidden" name="data_table_name" id="data_table_name" value="assessment-list">
                        <input type="hidden" name="table_name" id="table_name" value="assessments">
                  <thead>
                  <tr>
                    <th>Id</th>
                    <th>Title</th>
...
$(document).ready(function () {
    ...
    var tableData = $('#assessment-list').DataTable({
            //stateSave: true,
            processing: true,
            serverSide: true,
            ...
            ajax: {
                ...
                url: "{{ url('admin/courses/'.$course_id.'/assessments') }}",
                //url: "https://chatsupport.co.in/admin/courses/'.$course_id.'/assessments",
                type: 'GET',
            },
            ...
            columns: [
              ...
              {data: 'course.name', name: 'course.name','visible': true },
