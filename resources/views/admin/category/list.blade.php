        ...
        @endif
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <a href="{{url('admin/category/create')}}" class="btn btn-success" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp; Add category</a>
            </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="category-list" class="table table-bordered table-striped">
                <input type="hidden" name="data_table_name" id="data_table_name" value="category-list">
...
$(document).ready(function () {
    ...
    var tableData = $('#category-list').DataTable({
            //stateSave: true,
            processing: true,
            serverSide: true,
