        ...
        @endif
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <a href="{{url('admin/courses/'.$course_id.'/chapters/create')}}" class="btn btn-success" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp; Add Chapter</a>
            </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
$(document).ready(function () {
    ...
    var tableData = $('#chapter-list').DataTable({
            ...
            ajax: {
                 url: "{{ url('admin/courses/'.$course_id.'/chapters') }}",
                //url: "http://chatsupport.co.in/admin/courses/'.$course_id.'/chapters",
                type: 'GET',
            },
            ...
            columns: [
              ...
              {data: 'chapter', name: 'chapter','visible': true },
