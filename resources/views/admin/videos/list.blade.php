        ...
        @endif
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <a href="{{url('admin/chapters/'.$chapter_id.'/videos/create')}}" class="btn btn-success" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp; Add Videos</a>
            </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="videos-list" class="table table-bordered table-striped">
                <input type="hidden" name="data_table_name" id="data_table_name" value="videos-list">
                        <input type="hidden" name="table_name" id="table_name" value="chapter_videos">
                  <thead>
                  <tr>
                    <th>Id</th>
                    <th>Title</th>
...
$(document).ready(function () {
    ...
    var tableData = $('#videos-list').DataTable({
            //stateSave: true,
            processing: true,
            serverSide: true,
            ...
            ajax: {
                url: "{{ url('admin/chapters/'.$chapter_id.'/videos') }}",
                type: 'GET',
            },
